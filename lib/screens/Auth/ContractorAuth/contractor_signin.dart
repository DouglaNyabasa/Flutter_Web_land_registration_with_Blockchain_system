...
import '../../Dashboard/ContractorDashboard/Dashboard/contractor_dashboard.dart';
...
class ContractorSignIn extends StatefulWidget {

  const ContractorSignIn({Key? key,}) : super(key: key);

  @override
  _ContractorSignInState createState() => _ContractorSignInState();
}

class _ContractorSignInState extends State<ContractorSignIn> {
  ...
  void login(String email, password) async {
    try {
      var response = await http.post(
          Uri.parse("http://localhost/block_backend/public/contractor/auth"),
